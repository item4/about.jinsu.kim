...
const PartTimeJobPage: React.FC<PartTimeJobPageProps> = ({
  ...
  return (
    <Layout location={location} metadata={metadata}>
      ...
      <PartTimeJobSection>
        <SectionTitle>받지 않는 업무</SectionTitle>
        <ul>
          <li>대리시험</li>
          <li>
            과제물의 결과물만 요구하는 경우 (과제물은 과외의 경우에만 같이
            풀어드립니다)
          </li>
        </ul>
      </PartTimeJobSection>
      ...
      <PartTimeJobSection>
        ...
        <ol>
          ...
          <li>
            대리시험 응시 내지는 시험 도중 부정행위에 도움을 달라는 의뢰는 받지
            않습니다.
          </li>
          <li>
            과제물을 도와드리는 것은 어디까지나 공부를 하는 분에게 도움을 드리기
            위한 것이지, 학습할 의향 없이 답안만 요구하는 경우에는 일절 도움을
            드리지 않습니다.
          </li>
        </ol>
      </PartTimeJobSection>
